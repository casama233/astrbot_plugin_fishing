...
# 定义用户成就进度的数据结构
UserAchievementProgress = Dict[
    int, Dict[str, Any]
]  # {achievement_id: {progress: X, completed_at: Y}}
...
class AbstractItemTemplateRepository(ABC):
    ...
    # 添加道具模板
    @abstractmethod
    def add_item_template(self, item_data: Dict[str, Any]) -> Item:
        pass

    # 更新道具模板
    @abstractmethod
    def update_item_template(self, item_id: int, item_data: Dict[str, Any]) -> None:
        pass
    ...
    # 添加鱼类模板
    @abstractmethod
    def add_fish_template(self, fish_data: Dict[str, Any]) -> Fish:
        pass

    # 更新鱼类模板
    @abstractmethod
    def update_fish_template(self, fish_id: int, fish_data: Dict[str, Any]) -> None:
        pass
    ...
    # 添加鱼饵模板
    @abstractmethod
    def add_bait_template(self, bait_data: Dict[str, Any]) -> Bait:
        pass

    # 更新鱼饵模板
    @abstractmethod
    def update_bait_template(self, bait_id: int, bait_data: Dict[str, Any]) -> None:
        pass
    ...
    # 添加鱼竿模板
    @abstractmethod
    def add_rod_template(self, rod_data: Dict[str, Any]) -> Rod:
        pass

    # 更新鱼竿模板
    @abstractmethod
    def update_rod_template(self, rod_id: int, rod_data: Dict[str, Any]) -> None:
        pass
    ...
    # 添加饰品模板
    @abstractmethod
    def add_accessory_template(self, accessory_data: Dict[str, Any]) -> Accessory:
        pass

    # 更新饰品模板
    @abstractmethod
    def update_accessory_template(
        self, accessory_id: int, accessory_data: Dict[str, Any]
    ) -> None:
        pass
    ...
    # 添加称号模板
    @abstractmethod
    def add_title_template(self, title_data: Dict[str, Any]) -> Title:
        pass

    # 更新称号模板
    @abstractmethod
    def update_title_template(self, title_id: int, title_data: Dict[str, Any]) -> None:
        pass
...
class AbstractRedPacketRepository(ABC):
    @abstractmethod
