...
ROD_DATA = [
    ...
    ("新手木竿", "剛入門時的可靠伙伴。基礎均衡，無額外屬性加成。", 1, "shop", 50, 1.0, 1.0, 0.0, None, None),
    ("竹制鱼竿", "輕巧耐用的竹竿。雖然普通，但能稍微提升運氣。", 2, "shop", 500, 1.0, 1.0, 0.01, None, None),
    ("碳素纤维竿", "現代工藝的結晶，手感極佳。提升魚類品質與稀有度。", 3, "shop", 5000, 1.05, 1.0, 0.03, 1000, None),
    ("星辰钓者", "蘊含星光力量的神祕魚竿。顯著提升釣到高品質與稀有魚類的幾率。", 4, "gacha", None, 1.1, 1.0, 0.08, None, None),
    ("海神之赐", "傳說中海神波塞冬使用過的魚竿。全面提升各項釣魚屬性。", 5, "gacha", None, 1.2, 1.1, 0.15, None, None),
]

ACCESSORY_DATA = [
    # Format: (name, description, rarity, slot_type, quality_mod, quantity_mod, rare_mod, coin_mod, other_desc, icon_url)
    ("幸运四叶草", "帶來幸運的象徵。提升魚類品質與稀有度。", 2, "general", 1.05, 1.0, 0.01, 1.02, "提升魚類品質與稀有度", None),
    ("渔夫的戒指", "深受漁夫青睞的戒指。顯著提升釣魚獲得的金幣收益。", 3, "general", 1.0, 1.0, 0.0, 1.10, "金幣收益 +10%", None),
    ("丰收号角", "吹響號角，迎接大豐收。全面提升各類釣魚收益與品質。", 4, "general", 1.10, 1.05, 0.03, 1.15, "品質、數量、稀有度與金幣全面提升", None),
    ("海洋之心", "蘊含大海力量的神祕寶石。極大提升釣魚收益並縮短冷卻時間。", 5, "general", 1.20, 1.10, 0.05, 1.25, "全屬性極大提升，冷卻時間 -50%", None),
]
...
ITEM_DATA = [
    ...
    (
        0,
        "神秘钱袋",
        "一個會變換重量的神祕錢袋，誰也不知道裡面有多少錢。",
        3,
        "使用：隨機獲得 5,000 至 20,000 金幣。",
        0,
        True,
        None,
        "ADD_COINS",
    ...
    (
        0,
        "破厄护符·守",
        "銘刻止厄符文，於煉境崩毀之際護其本體無損。",
        4,
        "精煉保護：毀壞時改判為普通失敗，本體保留不降級。[僅對5星及以下裝備生效]",
        0,
        False,
        None,
    ...
    (
        0,
        "天命护符·神佑",
        "神佑加身，破而不滅。傳聞能庇佑至關的一煉。",
        5,
        "至高保護：任何失敗必改判為普通失敗，本體保留不降級。[對所有星級裝備生效]",
        0,
        False,
        None,
        "REFINE_DESTRUCTION_SHIELD",
