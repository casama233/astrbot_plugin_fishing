...
class AquariumService:
    ...
    def add_fish_to_aquarium(
        ...
        fish_item = next(
            (
                ...
                if item.fish_id == fish_id and item.quality_level == quality_level
            ),
            None,
        )
    ...
    def upgrade_aquarium(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if (
                updated_user
                and updated_user.aquarium_capacity != upgrade_config.capacity
            ):
                return {
                    "success": False,
    ...
    def get_aquarium_upgrade_info(self, user_id: str) -> Dict[str, Any]:
        ...
        upgrades = self.get_aquarium_upgrades()
        current_upgrade = self.inventory_repo.get_aquarium_upgrade_by_level(
            current_level
        )
